...
output_path = strcat(output_path, experiment_date, "_", experiment_type, "_", scheme, "_", extras, "/");
...
% shape_ax_proxfat_top_indices = shape_ax_proxfat_top_indices(1);
...
features_training = texture_ax_tumor_train;
...
features_holdout = texture_ax_tumor_test;

feature_column_names = texture_ax_tumor_top_names;
