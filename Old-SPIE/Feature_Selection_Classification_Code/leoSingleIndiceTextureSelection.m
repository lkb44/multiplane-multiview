...
output_path = strcat(output_path, experiment_date, "_", experiment_type, "_", scheme, "_", plane, "_", region, indiceT, "/");
...
features_training = datasets.texture_Coronal_CoronalTrainingTextureFeatures_Proximal_Fat.feature_matrix;
features_holdout = datasets.texture_Coronal_CoronalTestingTextureFeatures_Proximal_Fat.feature_matrix;
features_training = features_training(:, indice);
features_holdout = features_holdout(:, indice);
feature_column_names = feature_column_names(:, indice);
