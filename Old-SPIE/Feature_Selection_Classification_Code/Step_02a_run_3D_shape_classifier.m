...
experiment_type = "all"; % https://www.mathworks.com/help/matlab/ref/nchoosek.html#d123e968841 nchoosek(rois, 2)
...
elseif(length(view) == 1 && experiment_type == "all") % Single view with all lumne, rectal wall, and fat features
   ...
   lumen_train = datasets.train_lumen.feature_matrix; 
   if(view{1} == "Axial")
       lumen_train = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", lumen_train);
   elseif(view{1} == "Coronal")
       lumen_train = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", lumen_train); 
   end

   rw_train = datasets.train_rw.feature_matrix;
   if(view{1} == "Axial")
       rw_train = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", rw_train);
   elseif(view{1} == "Coronal")
       rw_train = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", rw_train);
       
   end
   
   fat_train = datasets.train_fat.feature_matrix;
   if(view{1} == "Axial")
       fat_train = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", fat_train);
   elseif(view{1} == "Coronal")
       fat_train = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", fat_train);  
   end
   ...
   lumen_test = datasets.test_lumen.feature_matrix;
   if(view{1} == "Axial")
       lumen_test = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", lumen_test);
   elseif(view{1} == "Coronal")
       lumen_test = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", lumen_test); 
   end
   
   rw_test = datasets.test_rw.feature_matrix;
   if(view{1} == "Axial")
       rw_test = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", rw_test);
   elseif(view{1} == "Coronal")
       rw_test = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", rw_test);
       
   end
   
   fat_test = datasets.test_fat.feature_matrix;
   if(view{1} == "Axial")
       fat_test = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", fat_test);
   elseif(view{1} == "Coronal")
       fat_test = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", fat_test);  
   end
   ...
   va_lumen_test = datasets.va_test_lumen.feature_matrix;
   if(view{1} == "Axial")
       va_lumen_test = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", va_lumen_test);
   elseif(view{1} == "Coronal")
       va_lumen_test = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", va_lumen_test); 
   end
   
   va_rw_test = datasets.va_test_rw.feature_matrix;
   if(view{1} == "Axial")
       va_rw_test = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", va_rw_test);
   elseif(view{1} == "Coronal")
       va_rw_test = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", va_rw_test);
       
   end
   
   va_fat_test = datasets.va_test_fat.feature_matrix;
   if(view{1} == "Axial")
       va_fat_test = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", va_fat_test);
   elseif(view{1} == "Coronal")
       va_fat_test = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", va_fat_test);  
   end
   ...
   lumen_feature_column_names = strcat(view{1}, "lumen_", feature_column_names);  
    if(view{1} == "Axial")
       lumen_feature_column_names = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", lumen_feature_column_names);
   elseif(view{1} == "Coronal")
       lumen_feature_column_names = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", lumen_feature_column_names); 
   end
   
   rw_feature_column_names = strcat(view{1}, "_rw_", feature_column_names);
   if(view{1} == "Axial")
       rw_feature_column_names = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", rw_feature_column_names);
   elseif(view{1} == "Coronal")
       rw_feature_column_names = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", rw_feature_column_names);
       
   end
   
   fat_feature_column_names = strcat(view{1}, "_fat_", feature_column_names);
   if(view{1} == "Axial")
       fat_feature_column_names = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", fat_feature_column_names);
   elseif(view{1} == "Coronal")
       fat_feature_column_names = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", fat_feature_column_names);  
   end
...
elseif(length(view) == 2 && experiment_type == "all") % Two views with all lumen, rectal wall, and fat features
    ...
    ax_lumen_train = datasets.Axial_train_lumen.feature_matrix;
    ax_lumen_train = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", ax_lumen_train);
    
    cor_lumen_train = datasets.Coronal_train_lumen.feature_matrix;
    cor_lumen_train = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", cor_lumen_train);
    
    ax_rw_train = datasets.Axial_train_rw.feature_matrix;
    ax_rw_train = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", ax_rw_train);
    
    cor_rw_train = datasets.Coronal_train_rw.feature_matrix;
    cor_rw_train = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", cor_rw_train);
    
    ax_fat_train = datasets.Axial_train_fat.feature_matrix;
    ax_fat_train = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", ax_fat_train);
    
    cor_fat_train = datasets.Coronal_train_fat.feature_matrix;
    cor_fat_train = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", cor_fat_train);
    
    features_training = [ax_lumen_train cor_lumen_train ax_rw_train cor_rw_train ax_fat_train cor_fat_train];
    
    ax_lumen_test = datasets.Axial_test_lumen.feature_matrix;
    ax_lumen_test = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", ax_lumen_test);
    
    cor_lumen_test = datasets.Coronal_test_lumen.feature_matrix;
    cor_lumen_test = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", cor_lumen_test);
    
    ax_rw_test = datasets.Axial_test_rw.feature_matrix;
    ax_rw_test = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", ax_rw_test);
    
    cor_rw_test = datasets.Axial_test_rw.feature_matrix;
    cor_rw_test = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", cor_rw_test);
    
    ax_fat_test = datasets.Axial_test_fat.feature_matrix;
    ax_fat_test = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", ax_fat_test);
    
    cor_fat_test = datasets.Coronal_test_fat.feature_matrix;
    cor_fat_test = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", cor_fat_test);
   
    features_holdout = [ax_lumen_test cor_lumen_test ax_rw_test cor_rw_test ax_fat_test cor_fat_test];
    
    ax_va_lumen_test = datasets.Axial_va_test_lumen.feature_matrix;
    ax_va_lumen_test = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", ax_va_lumen_test);
    
    cor_va_lumen_test = datasets.Coronal_va_test_lumen.feature_matrix;
    cor_va_lumen_test = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", cor_va_lumen_test);
    
    ax_va_rw_test = datasets.Axial_va_test_rw.feature_matrix;
    ax_va_rw_test = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", ax_va_rw_test);
    
    cor_va_rw_test = datasets.Coronal_va_test_rw.feature_matrix;
    cor_va_rw_test = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", cor_va_rw_test);
    
    ax_va_fat_test = datasets.Axial_va_test_fat.feature_matrix;
    ax_va_fat_test = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", ax_va_fat_test);
    
    cor_va_fat_test = datasets.Coronal_va_test_fat.feature_matrix;
    cor_va_fat_test = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", cor_va_fat_test);
    
    features_va = [ax_va_lumen_test cor_va_lumen_test ax_va_rw_test cor_va_rw_test ax_va_fat_test cor_va_fat_test];
    features_holdout = vertcat(features_holdout, features_va);
    
    ax_lumen_feature_column_names = strcat(view{1}, "_lumen_", feature_column_names);
    ax_lumen_feature_column_names = filter_features("09-Aug-2022_00_27_39_Axial_lumen_only", ax_lumen_feature_column_names);
    
    cor_lumen_feature_column_names = strcat(view{2}, "_lumen_", feature_column_names);
    cor_lumen_feature_column_names = filter_features("09-Aug-2022_10_23_25_Coronal_lumen_only", cor_lumen_feature_column_names);
    
    ax_rw_feature_column_names = strcat(view{1}, "_rw_", feature_column_names);
    ax_rw_feature_column_names = filter_features("09-Aug-2022_00_27_49_Axial_rw_only", ax_rw_feature_column_names);
    
    cor_rw_feature_column_names = strcat(view{2}, "_rw_", feature_column_names);
    cor_rw_feature_column_names = filter_features("09-Aug-2022_10_23_43_Coronal_rw_only", cor_rw_feature_column_names);
    
    ax_fat_feature_column_names = strcat(view{1}, "_fat_", feature_column_names);
    ax_fat_feature_column_names = filter_features("09-Aug-2022_00_27_58_Axial_fat_only", ax_fat_feature_column_names);
    
    cor_fat_feature_column_names = strcat(view{2}, "_fat_", feature_column_names);
    cor_fat_feature_column_names = filter_features("09-Aug-2022_10_23_55_Coronal_fat_only", cor_fat_feature_column_names);
...
function output_feat_matrix = filter_features(experimentID, feat_matrix)

    top_feat_indices = readmatrix(strcat("../Shape_Feature_Results/", experimentID, "/Top_Features_Information.xlsx"));
    top_feat_indices = top_feat_indices(:,1);
    output_feat_matrix = feat_matrix(:,top_feat_indices);
