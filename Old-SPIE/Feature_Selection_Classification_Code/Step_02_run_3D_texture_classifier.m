...
if(length(view) == 1 && view{1} == "Axial")
    train_matrix_path = "../Texture_Features/Axial/train/";
    test_matrix_path = "../Texture_Features/Axial/test/";
    va_test_matrix_path = "../Texture_Features/Axial/va_test/";
elseif(length(view) == 1 && view{1} == "Coronal")
    train_matrix_path = "../Texture_Features/Coronal/train/"; 
    test_matrix_path = "../Texture_Features/Coronal/test/";
    va_test_matrix_path = "../Texture_Features/Coronal/va_test/";
elseif(length(view) == 2)
    ...
    ax_train_matrix_path = "../Texture_Features/Axial/train/";
    ax_test_matrix_path = "../Texture_Features/Axial/test/";
    ax_va_test_matrix_path = "../Texture_Features/Axial/va_test/";
    cor_train_matrix_path = "../Texture_Features/Coronal/train/"; 
    cor_test_matrix_path = "../Texture_Features/Coronal/test/";
    cor_va_test_matrix_path = "../Texture_Features/Coronal/va_test/";
end

% Create cell array with names of each feature
feature_column_names = load("../Texture_Features/Coronal/train/StatName.mat");
...
if(length(view) == 1)
    for i=1:length(rois)
        path_to_train = strcat(train_matrix_path, view{1}, "_", rois{i}, "_train_3D_texture_features.mat");
        datasets.(strcat("train_",rois{i})) = load(path_to_train);

        path_to_test = strcat(test_matrix_path, view{1}, "_", rois{i}, "_test_3D_texture_features.mat");
        datasets.(strcat("test_",rois{i})) = load(path_to_test);
        
        path_to_test = strcat(va_test_matrix_path, view{1}, "_", rois{i}, "_va_test_3D_texture_features.mat");
    ...
    for i=1:length(rois)
        ...
        % Axial datasets
        path_to_train = strcat(ax_train_matrix_path, view{1}, "_", rois{i}, "_train_3D_texture_features.mat");
        datasets.(strcat(view{1}, "_train_",rois{i})) = load(path_to_train);
        
        path_to_test = strcat(ax_test_matrix_path, view{1}, "_", rois{i}, "_test_3D_texture_features.mat");
        datasets.(strcat(view{1}, "_test_",rois{i})) = load(path_to_test);
        
        path_to_test = strcat(ax_va_test_matrix_path, view{1}, "_", rois{i}, "_va_test_3D_texture_features.mat");
        datasets.(strcat(view{1}, "_va_test_",rois{i})) = load(path_to_test);
        
        % Coronal Datasets
        path_to_train = strcat(cor_train_matrix_path, view{2}, "_", rois{i}, "_train_3D_texture_features.mat");
        datasets.(strcat(view{2}, "_train_",rois{i})) = load(path_to_train);
        
        path_to_test = strcat(cor_test_matrix_path, view{2}, "_", rois{i}, "_test_3D_texture_features.mat");
        datasets.(strcat(view{2}, "_test_",rois{i})) = load(path_to_test);
        
        path_to_test = strcat(cor_va_test_matrix_path, view{2}, "_", rois{i}, "_va_test_3D_texture_features.mat");
