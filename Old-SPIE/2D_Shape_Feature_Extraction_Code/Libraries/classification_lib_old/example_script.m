%% setup
clear;clc;
%addpath(genpath('G:\Team Drives\INVent\jacob\Code\classification'));
addpath(genpath('/media/charlems/3307FC630536C597/RectumData/Code/Matlab/classification'));
%addpath('G:\Team Drives\INVent\jacob\Code\feature_selection');
addpath('/media/charlems/3307FC630536C597/RectumData/Code/Matlab/feature_selection');
