...
problems = [];
pathIn = '/Users/leobao/Documents/MultiPlanePipeline/AACR2023/ValidationData/Coronal/';

DirectoryIn= '/Users/leobao/Documents/MultiPlanePipeline/AACR2023/ValidationData/Coronal/Patient-*';
pathOut= '/Users/leobao/Documents/MultiPlanePipeline/AACR2023/ValidationData/Patients/';
...
for k= 1:length(theFilesvol)
    ...
    img_file_in = strcat(pathIn, '/', theFilesvol{k}, '/', theFilesvol{k}, '_cor.mha');
    mask_file_in = strcat(pathIn, '/', theFilesvol{k}, '/', theFilesvol{k}, '_cor_label.mha');
